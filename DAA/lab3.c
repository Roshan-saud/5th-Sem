...
/*
Title: Binary search and Min-Max Finding Algorithm using Recursion

Objective:
 - To implement the Binary Search algorithm using recursion
 - To find the minimum and maximum elements using a recursion approach
*/
